...
export class StockAnalysisStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props: StockAnalysisLambdaStackProps) {
        ...
        /***         * Lambda         */
        const downloadStocksFunction = new NodejsFunction(this, props.resourceName.lambdaName('download-stocks'), {
            entry: 'assets/lambdas/download-stocks/index.ts',
            handler: 'handler',
        ...
        s3.grantPut(downloadStocksFunction);
        ...
        rule.addTarget(
            new LambdaFunction(downloadStocksFunction, {
